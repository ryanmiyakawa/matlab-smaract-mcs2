...
classdef MCS2 % < smaract.MCSAbstract2
...
%         /**********************************************************/
    ...
    methods (Access = protected)
        ...
        function this = setDefaultPathOfDllAndHeader(this)
            ...
            switch cArch
                case 'win64'
                    ...
                    this.cPathDll = fullfile(cDirSdk, 'lib64', 'SmarActCTL.lib');
                    this.cPathHeader = fullfile(cDirSdk, 'include', 'SmarActControl.h');

                
                otherwise
                    % Assume 32-bit
                    this.cNameOfLib = 'MCSControl'; % The name of the .dll file
                    this.cPathDll = fullfile(cDirSdk, 'lib', 'SmarActCTL.lib');
                    this.cPathHeader = fullfile(cDirSdk, 'include', 'SmarActControl.h');
            end
       ...
       function l = hasProp(this, c)
        ...
        function this = init(this)
            ...
            this = this.setDefaultPathOfDllAndHeader();
             ...
             this.u32MaxHoldTime = this.SA_CTL_INFINITE;
